                        ...
                        echo"
                                <div class='back-bet'>
                                    ...
                                    <form method='post' action='manage_over_under.php'>
                                        ...
                                        <input type='number' name='odd' step='0.1' value='".$row['ov']."' readonly>
                                        <div class='stake'>
                                        ...
                                        <div class='buttons'>
                                            ...
                                            <button type='submit' name='back-over-under'>Place bet</button>
                                        </div>
                                    </form>
                                </div>
                            ";
                        ...
                        echo"
                                <div class='back-bet'>
                                    ...
                                    <form method='post' action='manage_over_under.php'>
                                        ...
                                        <input type='number' name='odd' step='0.1' value='".$row['under']."' readonly>
                                        <div class='stake'>
