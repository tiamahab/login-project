                        ...
                        echo"
                                <div class='lay-bet'>
                                    ...
                                    <form method='post' action='manage_lay.php'>
                                        ...
                                        <input type='number' name='odd' step='0.1' value='".$row['awayw']."'>
                                        <div class='stake'>
                                        ...
                                        <div class='buttons'>
                                            ...
                                            <button type='submit' name='lay-bet'>Place bet</button>
                                        </div>
                                    </form>
                                </div>
                            ";
                        ...
                        echo"
                                <div class='lay-bet'>
                                    ...
                                    <form method='post' action='manage_lay.php'>
                                        ...
                                        <input type='number' name='odd' step='0.1' value='".$row['homew']."'>
                                        <div class='stake'>
                        ...
                        echo"
                                <div class='lay-bet'>
                                    ...
                                    <form method='post' action='manage_lay.php'>
                                        ...
                                        <input name='kind' value='".$kind."' style='display:none;'>
                                        <input name='matchid' value='".$_SESSION['matchId']."' style='display:none;'>
                                        <input type='number' name='odd' step='0.1' value='".$row['draw']."'>
                                        <div class='stake'>
                                            <span>UGX:</span><input type='number' name='stake' step='0.1' placeholder='enter money..'>
                                        </div>
